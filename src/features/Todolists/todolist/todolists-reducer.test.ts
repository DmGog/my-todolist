import {
    ...
    todolistsReducer, changeTodolistEntityStatusAC, fetchTodosTC, deleteTodoTC, createTodoTC, updateTodoTitleTC
} from "./todolistsSlice"
import {v1} from "uuid"
...
test("set todolists", () => {
    ...
    const action = fetchTodosTC.fulfilled({todolists: startState}, "requestId")
